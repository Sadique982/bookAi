  ...
  return (
    <header className='flex flex-col flex-wrap md:flex-row justify-between'>
      ...
      <nav className='flex flex-row items-center flex-wrap font-light'>
        <Link to='features' smooth={true} duration={500} className='m-2 hover:text-accentColor'>
          Features
        </Link>
        ...
        <Link to='roadmap' smooth={true} duration={500} className='m-2 hover:text-accentColor'>
          Roadmap
        </Link>

        <Link to='api' smooth={true} duration={500} className='m-2 hover:text-accentColor'>
          API
        </Link>

        <Link to='price' smooth={true} duration={500} className='m-2 hover:text-accentColor'>
          Price
        </Link>

        <Link to='models' smooth={true} duration={500} className='m-2 hover:text-accentColor'>
          Models
        </Link>

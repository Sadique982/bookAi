...
function NewsLetter() {
  return (
    <section className="newsletter text-center mx-20 mt-14 rounded-lg">
      ...
      <form action="" className="flex gap-4 justify-center mt-5 w-full">
        <input
          className="p-3 border-none rounded-md text-lg text-slate-800 w-2/3"
          type="email"

...
function Testimonials() {
  return (
    <section className="text-center mt-16 mx-5">
      <h3 className="font-bold text-textColor text-2xl">What Our Users Say</h3>
      <div className="testimonials grid grid-cols-1 md:grid-cols-2 gap-5 p-5">
        ...
        <div className="testimonial py-5 px-4 rounded-lg">
          <q>
            The AI-generated ideas helped me overcome writer's block. It's like
            having a co-author at your fingertips.
          </q>
          <div className="text-lg font-semibold">- Mark T., Aspiring Writer</div>
        </div>
      </div>
    </section>
  );
